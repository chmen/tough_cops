  ...
  <header class="bg-grey-lighter py-4">
    <div class="container m-auto flex flex-wrap items-center justify-end">
      <div class="flex-1 flex items-center">
        ...
        <a href="/" class="uppercase text-sm font-mono pl-4 font-semibold no-underline text-indigo-dark hover:text-indigo-darker">Tough cops</a>
      </div>
      <div>
        ...
        <router-link to="/posts" class="link-grey px-2 no-underline">Posts</router-link>
